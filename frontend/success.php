...
<?php
    ...
    if($code == 200 && !( curl_errno($handle)))
    {
        ...
        $donationInfo = "UPDATE donationinfo SET d_amount = '$d_amount', donation_status = 'Complete', t_id = '$tran_id', t_date = '$tran_date', t_status = '$status', t_method = '$card_type' WHERE p_key = '$p_key'";
